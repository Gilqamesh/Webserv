...
link_flags =
compiler = clang++
server_files = Network.cpp server.cpp utils.cpp http_request.cpp http_response.cpp resource.cpp
server_headers = header.hpp http_request.hpp server.hpp utils.hpp http_response.hpp resource.hpp
